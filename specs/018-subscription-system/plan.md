...
├── migrations/
│   └── 20260716130000_subscription_entitlements.sql   # NEW — enums, entitlements, billing_events, RLS, ensure_entitlement()
...
iOS/Ortho-iOS/                           # ⚠ 2026-07-16 merge addendum: this ENTIRE subtree was
│                                        #   DROPPED at the post-021 reconciliation (tasks.md T046) —
│                                        #   iOS ships the web bundle via the Capacitor shell.
