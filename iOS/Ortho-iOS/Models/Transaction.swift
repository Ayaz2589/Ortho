...
extension Transaction {
    ...
    static let sample: [Transaction] = {
        let maya = Person.mayaSample.id
        let jordan = Person.jordanSample.id
        let both: Set<Person.ID> = [maya, jordan]

        // Spans ~3 months so the dashboard range / month picker have data to
        // navigate; every expense carries `paidBy` (so member balances are
        // non-zero) and two `.transfer` rows exercise settle-up.
        return [
            // This week
            makeSample(merchant: "Blue Bottle Coffee",   category: .coffee,    kind: .expense,  cents: 575,     ownerIDs: [maya],   source: "Amex Gold",      daysAgo: 1,  hour: 8,  minute: 24, createdBy: maya,   paidBy: maya),
            makeSample(merchant: "Whole Foods",          category: .groceries, kind: .expense,  cents: 8742,    ownerIDs: both,     source: "ACH · Joint",    daysAgo: 2,  hour: 12, minute: 8,  createdBy: jordan, paidBy: jordan),
            makeSample(merchant: "Sweetgreen",           category: .dining,    kind: .expense,  cents: 1620,    ownerIDs: [jordan], source: "Chase Sapphire", daysAgo: 3,  hour: 13, minute: 14, createdBy: jordan, paidBy: jordan),
            makeSample(merchant: "Greenwood Apartments", category: .rent,      kind: .expense,  cents: 285_000, ownerIDs: both,     source: "ACH · Joint",    daysAgo: 5,  hour: 9,  minute: 0,  createdBy: maya,   paidBy: maya),
            makeSample(merchant: "Settle up",            category: .transfer,  kind: .transfer, cents: 40_000,  ownerIDs: [maya],   source: "ACH · Joint",    daysAgo: 6,  hour: 20, minute: 0,  createdBy: jordan, paidBy: jordan),

            // Last few weeks
            makeSample(merchant: "Shell",                category: .fuel,      kind: .expense,  cents: 4210,    ownerIDs: [jordan], source: "Chase Sapphire", daysAgo: 9,  hour: 17, minute: 42, createdBy: jordan, paidBy: jordan),
            makeSample(merchant: "Spotify Family",       category: .subs,      kind: .expense,  cents: 1699,    ownerIDs: both,     source: "Apple Card",     daysAgo: 12, hour: 6,  minute: 0,  createdBy: maya,   paidBy: maya),
            makeSample(merchant: "ConEd",                category: .utilities, kind: .expense,  cents: 9416,    ownerIDs: both,     source: "ACH · Joint",    daysAgo: 16, hour: 10, minute: 0,  createdBy: jordan, paidBy: maya),
            makeSample(merchant: "Payroll — Acme Co.",   category: .income,    kind: .income,   cents: 342_000, ownerIDs: [maya],   source: "ACH · Checking", daysAgo: 20, hour: 6,  minute: 0,  createdBy: maya),
            makeSample(merchant: "Trader Joe's",         category: .groceries, kind: .expense,  cents: 5428,    ownerIDs: both,     source: "Amex Gold",      daysAgo: 24, hour: 18, minute: 18, createdBy: maya,   paidBy: maya),
            makeSample(merchant: "Uber",                 category: .transit,   kind: .expense,  cents: 1850,    ownerIDs: [maya],   source: "Amex Gold",      daysAgo: 28, hour: 21, minute: 42, createdBy: maya,   paidBy: maya),

            // Last month
            makeSample(merchant: "CVS Pharmacy",         category: .health,    kind: .expense,  cents: 1240,    ownerIDs: [jordan], source: "Apple Card",     daysAgo: 38, hour: 11, minute: 32, createdBy: jordan, paidBy: jordan),
            makeSample(merchant: "AMC Theatres",         category: .entertainment, kind: .expense, cents: 3800, ownerIDs: both,     source: "Amex Gold",      daysAgo: 44, hour: 19, minute: 15, createdBy: maya,   paidBy: maya),
            makeSample(merchant: "Greenwood Apartments", category: .rent,      kind: .expense,  cents: 285_000, ownerIDs: both,     source: "ACH · Joint",    daysAgo: 51, hour: 9,  minute: 0,  createdBy: jordan, paidBy: jordan),
            makeSample(merchant: "Settle up",            category: .transfer,  kind: .transfer, cents: 25_000,  ownerIDs: [jordan], source: "ACH · Joint",    daysAgo: 58, hour: 20, minute: 0,  createdBy: maya,   paidBy: maya),

            // Two months back
            makeSample(merchant: "Costco",               category: .groceries, kind: .expense,  cents: 12_750,  ownerIDs: both,     source: "ACH · Joint",    daysAgo: 74, hour: 15, minute: 0,  createdBy: maya,   paidBy: maya),
            makeSample(merchant: "Netflix",              category: .subs,      kind: .expense,  cents: 2299,    ownerIDs: both,     source: "Apple Card",     daysAgo: 88, hour: 7,  minute: 0,  createdBy: maya,   paidBy: maya),
        ]
    }()
}
