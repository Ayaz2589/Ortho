...
/**
 * The cross-surface gate derivation. Mirrored BY HAND in web/lib/entitlements.ts
 * (the Capacitor iOS shell ships that same web copy); both are locked by the identical literal
